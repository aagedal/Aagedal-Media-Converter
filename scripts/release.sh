...
python3 scripts/verify-release-bundle.py "$APP_PATH" --architecture arm64 --require-hardened-runtime --manifest BundledDependencies.json
...
python3 scripts/verify-release-bundle.py "$VERIFY_DIR/$SCHEME.app" --architecture arm64 --require-hardened-runtime --manifest BundledDependencies.json --report "$BUILD_DIR/Release-Footprint.json"
