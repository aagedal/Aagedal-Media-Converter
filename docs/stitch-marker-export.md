...
Timeline editing shortcuts: **Q** ripple-trims the start of the clip under the playhead; **W** ripple-trims its end. Later clips close the gap automatically. At a cut, the clip to its right is targeted; at least one frame is retained. **Reset trim** restores both ends of every selected clip, including Shift-selected ranges.
