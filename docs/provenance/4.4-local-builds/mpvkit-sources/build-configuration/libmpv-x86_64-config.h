...
#define CONFIGURATION "-Dlibmpv=true -Dgl=enabled -Dplain-gl=enabled -Diconv=enabled -Duchardet=enabled -Dvulkan=enabled -Dmoltenvk=enabled -Djavascript=disabled -Dzimg=disabled -Djpeg=disabled -Dvapoursynth=disabled -Drubberband=disabled -Dgpl=true -Dlibbluray=enabled -Dcplayer=false '-Dswift-flags=-sdk /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.5.sdk -target x86_64-apple-macos12.0' -Dcocoa=enabled -Dcoreaudio=enabled -Davfoundation=enabled -Dgl-cocoa=enabled -Dvideotoolbox-gl=enabled -Dvideotoolbox-pl=enabled -Dlua=disabled --cross-file=/Users/truls.aagedal/Developer/MPVKit/dist/libmpv/macos/scratch/x86_64/crossFile.meson"
...
#define MPV_CONFDIR "/Users/truls.aagedal/Developer/MPVKit/dist/libmpv/macos/thin/x86_64/etc/mpv"
